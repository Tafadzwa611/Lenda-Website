            ...
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left space-y-6 animate-in slide-in-from-left-8 duration-700 fade-in order-2 lg:order-1 pt-10 lg:pt-0 pb-12 lg:pb-0">
              ...
              <div className="max-w-xl w-full">
                <p className="text-lg md:text-xl text-slate-300 leading-relaxed font-light">
                  Streamline your financial operations with a robust, multi-currency Core Banking System designed to bridge the gap in the <span className="text-sky-400 font-semibold">African financial sector</span>. Focus on delivering new products and expanding efficiently across the continent while we handle the backend complexity with automated lending, risk management, and compliance.
                </p>
              </div>
